...
export function CartSheet() {
    ...
    // 👇 Lógica para bloquear/habilitar el scroll de la página principal
    useEffect(() => {
        if (isOpen) {
            // Bloquea el scroll y evita el salto visual quitando el scrollbar
            document.body.style.overflow = 'hidden';
        } else {
            // Habilita el scroll nuevamente
    ...
    return (
        <div className="fixed inset-0 z-[100] flex justify-end">
            ...
            <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
                ...
                {/* Lista de Productos (Mantiene tu diseño exacto) */}
                ...
                {items.length > 0 && (
                    <div className="p-6 bg-white border-t border-gray-100 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] z-20">
                        ...
                        {/* Etiquetas de bancos (Tus tamaños exactos) */}
