            ...
            <div className="relative w-full max-w-md bg-white h-full shadow-2xl flex flex-col animate-in slide-in-from-right duration-300">
                ...
                {items.length > 0 && (
                    <div className="p-6 border-t border-gray-100 bg-gray-50/50">
                        ...
                        {/* 👈 AQUÍ REEMPLAZAMOS EL BOTÓN DE WHATSAPP POR EL LINK A /CHECKOUT */}
                        <Link
                            href="/checkout"
                            onClick={closeCart} // Importante: Cierra el carrito lateral al navegar
                            className="w-full bg-gray-900 hover:bg-black text-white py-4 rounded-xl font-bold text-lg flex items-center justify-center gap-2 shadow-lg transition-all active:scale-95"
                        >
                            Proceder al Pago
                            <ArrowRight size={20} />
                        </Link>

                        <p className="text-center text-[11px] text-gray-500 mt-3">Podrás ingresar tus datos de envío en el siguiente paso.</p>
                    </div>
                )}
