    ...
    return (
        <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <form id="edit-form" onSubmit={handleSubmit} className="p-8 space-y-6">
                ...
                {/* Categoría, Género y Tipo de Prenda */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="space-y-2">
                        ...
                        >
                            <option value="READY_MADE">Ready-to-wear (Físico)</option>
                    ...
                    <div className="space-y-2">
                        <label className="text-xs font-semibold text-gray-700 uppercase">Género</label>
                        <select
                            name="gender"
                    ...
                    {/* 👇 NUEVO: Selector de Tipo de Prenda */}
                    <div className="space-y-2">
                        <label className="text-xs font-semibold text-gray-700 uppercase">Tipo Prenda</label>
                        <select
                            name="clothingType"
