...
export function TermsContent() {
    return (
        <div className="space-y-8 sm:space-y-10 text-gray-600 text-sm sm:text-base leading-relaxed">
            ...
            <section>
                <h3 className="text-xl font-bold text-gray-900 mb-4">2. Proceso de Compra</h3>
                <p className="mb-4">
            ...
            <section>
                <h3 className="text-xl font-bold text-gray-900 mb-4">3. Políticas de Pago y Seguridad</h3>
                <p className="mb-4">
                ...
                <div className="bg-blue-50 p-5 sm:p-6 rounded-2xl border border-blue-100 text-blue-800 my-6 shadow-sm">
                    <h4 className="font-bold text-blue-900 mb-3 text-base">Políticas de Adelanto por Volumen de Compra:</h4>
                    <p className="mb-4">Para garantizar la seriedad de los pedidos que involucran montos mayores, aplicamos el siguiente esquema de adelantos:</p>
                    ...
                    <p className="text-xs sm:text-sm font-medium text-blue-600/90 italic mt-4 pt-4 border-t border-blue-200/50">
            ...
            <section>
                <h3 className="text-xl font-bold text-gray-900 mb-4">4. Envíos y Entregas</h3>
                <div className="mb-6 p-5 sm:p-6 bg-blue-50 text-blue-800 rounded-2xl border border-blue-100 shadow-sm">
                ...
                <ul className="list-disc pl-5 space-y-4 mb-4">
                    ...
                    <li>
                        ...
                        <div className="mt-4 p-4 bg-blue-50 text-blue-800 rounded-xl border border-blue-100 text-sm sm:text-base">
                            <span className="font-bold text-blue-900">Excepción importante:</span> El costo logístico de envío local (<strong>S/ 10.00</strong>) deberá ser abonado <strong>por adelantado</strong> obligatoriamente. Esto nos permite programar y asegurar la ruta del despachador de manera eficiente.
                        </div>
                    </li>
                </ul>
            </section>
