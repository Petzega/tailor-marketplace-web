                ...
                <div className="flex flex-col flex-1 mt-4 px-1">
                    ...
                    <div className="mt-auto flex flex-col gap-4">
                        ...
                        <div className="w-full">
                            {isOutOfStock ? (
                                <button disabled className="w-full h-11 flex items-center justify-center gap-2 bg-gray-50 text-gray-400 font-medium rounded-lg text-xs cursor-not-allowed border border-gray-200">
                                    No disponible
                                </button>
                            ) : isService ? (
                                <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="w-full h-11 flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold rounded-lg text-xs transition-colors shadow-sm active:scale-[0.98]">
                                ...
                                <div className="grid grid-cols-[1fr_44px] gap-2 h-11">
                                    ...
                                    <a href={whatsappLink} target="_blank" rel="noopener noreferrer" className="flex h-full w-full items-center justify-center rounded-lg bg-[#25D366] hover:bg-[#20bd5a] text-white shadow-md active:scale-[0.98]">
